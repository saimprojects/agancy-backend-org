...
ROOT_URLCONF = 'saim_enterprises.urls'
...
WSGI_APPLICATION = 'saim_enterprises.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@saienterprises.com')
...
JAZZMIN_SETTINGS = {
    "site_title": "Saim Enterprises Admin",
    "site_header": "Saim Enterprises",
